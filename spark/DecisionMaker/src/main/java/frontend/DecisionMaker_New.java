...
public final class DecisionMaker_New {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final JavaPairRDD<String, Map<String, double[]>> historyPairDResult = JavaPairRDD.fromJavaRDD(historyDResult);
    ...
    class CleanTime implements Serializable{
        public int cleantime;
        private static final long serialVersionUID = 5462223600l;
        public CleanTime() {cleantime = 0;}
    }
    final CleanTime cleanTime = new CleanTime();
    ...
    qualitySums.foreachRDD(new VoidFunction<JavaPairRDD<String, Map<String, double[]>>>() {
        ...
        public void call(JavaPairRDD<String, Map<String, double[]>> groups) throws Exception {
            ...
            if (cleanTime.cleantime >= 15)
            {
                cleanTime.cleantime = 0;
                combinedResult = queue.poll();
                queue.add(historyPairDResult);
                System.out.println("restart UCB");
            }
